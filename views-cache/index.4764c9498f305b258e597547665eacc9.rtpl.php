        ...
        <div class="col-lg-3 col-6">
          ...
          <a href="/marcacoes">
            <div class="small-box bg-success">
              <div class="inner">
                <h3 id="log1" class="counter"><?php echo htmlspecialchars( $confirmedTags, ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
        ...
        <div class="col-lg-3 col-6">
          ...
          <a href="/marcacoes">
            <div class="small-box bg-warning">
              <div class="inner">
                <h3 id="log2" class="counter"><?php echo htmlspecialchars( $noAnswerTags, ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
        ...
        <div class="col-lg-3 col-6">
          ...
          <a href="/marcacoes">
            <div class="small-box bg-danger">
              <div class="inner">
                <h3 id="log3" class="counter"><?php echo htmlspecialchars( $unmarkedTags, ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
...
<script>
  ...
  const val1 = log1.innerText;

  const log2 = document.querySelector("#log2");
  const val2 = log2.innerText;

  const log3 = document.querySelector("#log3");
  const val3 = log3.innerText;
</script>